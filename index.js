...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source Coded By Naftehi & Mikkey \nYoutube : @naftehi');
    ...
    const options = {
        ...
        headers: {
            ...
            'X-RapidAPI-Key': 'e86cb90101msh2361bb5e0bdf47cp141b01jsn2daba7794acb',
    ...
    fetch('https://chatgpt53.p.rapidapi.com/', options).then((response) => response.json()).then((response) => {
        ...
        if (err.name === 'TypeError') {
            appendMessage('bot', 'Sorry! There is an error! Maybe check your Api key.');
            buttonIcon.classList.add('fa-solid', 'fa-paper-plane');
            buttonIcon.classList.remove('fas', 'fa-spinner', 'fa-pulse');
        }
    });
